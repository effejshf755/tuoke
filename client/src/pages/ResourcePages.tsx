...
export function ResourceSubscriptionsPage() {
  ...
  const detail = useQuery<SubscriptionDetail>({queryKey:['resource-subscription-detail',selected],queryFn:()=>apiFetch(`/api/resources/subscriptions/${selected}`),enabled:selected!==null,refetchInterval:30_000})
